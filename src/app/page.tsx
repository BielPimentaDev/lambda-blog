		...
		<main className='max-w-screen-xl mx-auto px-6 bg-white '>
			...
			<section className='bg-white '>
				<div className='py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6'>
					<div className='mx-auto max-w-screen-sm text-center'>
						...
						<a
							href='#'
							className='text-white p-3 text-base bg-black hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg  px-5 py-2.5 mr-2 mb-2  focus:outline-none '>
			...
			<section className='bg-white '>
				<div className='flex justify-between items-center pr-6'>
					<h3 className='mb-4 text-2xl lg:text-3xl tracking-tight font-extrabold text-gray-900 '>
						Our Latest Posts
					</h3>
