...
export default function Header() {
	return (
		<header className='bg-black text-white'>
			<nav className='max-w-[1500px] mx-auto border-gray-200 px-4 lg:px-6 py-2.5 '>
					...
					<div
						...
						<ul className='flex flex-col mt-4 text-gray-400 font-medium lg:flex-row lg:space-x-8 lg:mt-0'>
							...
							<li>
								<a
									href='#'
									className='block py-2 pr-4 pl-3  border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-white lg:p-0  '>
									Company
								</a>
							</li>
							<li>
